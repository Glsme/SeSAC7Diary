...
class WalkThroughViewController: UIPageViewController {
    ...
    func createPageViewController() {
        ...
        let vc1 = sb.instantiateViewController(withIdentifier: FistViewController.reuseIdentifier) as! FistViewController
...
extension WalkThroughViewController: UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        ...
        //현재 페이지 뷰 컨트롤러에 보이는 viewController의 인덱스 가져오기
    ...
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerAfter viewController: UIViewController) -> UIViewController? {
        ...
        return nextIndex > 2 ? nil : pageViewControllerList[nextIndex]
    }
